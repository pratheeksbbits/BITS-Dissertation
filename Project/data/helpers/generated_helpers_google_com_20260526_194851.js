class GeneratedPageHelpers {
  ...
  async fillInput46bc13bb03f41cf0(value) {
  ...
  async fillInputQKsVaqOsBv7P2roP(value) {
    await this.page.fill("[name=\"ei\"]", value);
  }

  // element_id=44, tag=input, stable=true
  async fillInputAFdpzrgAAAAAahW5(value) {
  ...
  // element_id=78, tag=div, stable=false

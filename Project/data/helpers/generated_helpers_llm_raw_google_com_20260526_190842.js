class GeneratedPageHelpers {
  ...
  async waitForElementDarkThemeOff() {
  ...
  async waitForElementK1zIA() {
    await this.page.waitForSelector('.k1zIA');
  }

  async waitForElementReportInappropriatePredictions() {
    await this.page.waitForSelector('.WzNHm');
  }

  async waitForElementChooseFeedback() {
